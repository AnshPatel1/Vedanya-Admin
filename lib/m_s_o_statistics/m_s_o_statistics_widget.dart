...
class _MSOStatisticsWidgetState extends State<MSOStatisticsWidget>
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return FlutterFlowDropDown(
                                    initialOption: dropDownValue ??=
                                        getJsonField(
                                      (dropDownGetMSOSResponse?.jsonBody ?? ''),
                                      r'''$[0].name''',
                                    ).toString(),
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: Text(
                                                  '₹${getJsonField(
                                                    (mainContentGetStatisticsByMSOResponse
                                                            ?.jsonBody ??
                                                        ''),
                          ...
                          Container(
                            ...
                            child: FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final listViewSBLRsAsPairsIdResponse =
                                    snapshot.data;
                                return Builder(
                                  builder: (context) {
                                    final msoPair = (getJsonField(
                                              (listViewSBLRsAsPairsIdResponse
                                                      ?.jsonBody ??
                                                  ''),
                                              r'''$''',
                                            )?.toList() ??
